...
@WebServlet(urlPatterns = {"/GetAlumnos"})
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    out.println("<td>");
                    out.println(rs.getString("id_alumnos"));
                    out.println("</td>");
                    out.println("<td>");
                    ...
                    out.println("</td>");
                    out.println("<td>");
                    out.println(rs.getString("nro_doc"));
                    out.println("</td>");
                    out.println("<td class=\"hidden\">");
                    out.println(rs.getString("id_carrera"));
                    out.println("</td>");
                    out.println("<td>");
                ...
                Logger.getLogger(GetAlumnos.class.getName()).log(Level.SEVERE, null, ex);
